...
VirtualSky.prototype.createSky = function(){
	...
	for (var i = 0; i < this.hooks.createSky.length; ++i){
		if(typeof this.hooks.createSky[i].init=="function") this.hooks.createSky[i].init.call(this);
	}
...
VirtualSky.prototype.endClip = function(){
	for (var i = 0; i < this.hooks.endClip.length; ++i){
		if(typeof this.hooks.endClip[i].init=="function") this.hooks.endClip[i].init.call(this);
	}
